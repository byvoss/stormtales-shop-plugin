...
class ProductQuery extends ElementQuery
{
    ...
    protected function beforePrepare(): bool
    {
        ...
        $this->query->select([
            ...
            'stormtaleshop_products.primaryImageId',
            'stormtaleshop_products.frontImagesIds',
            'stormtaleshop_products.backImagesIds',
            'stormtaleshop_products.sideImagesIds',
            'stormtaleshop_products.detailImagesIds',
            'stormtaleshop_products.lifestyleImagesIds',
            'stormtaleshop_products.sizeChartId',
            'stormtaleshop_products.videoIds',
            'stormtaleshop_products.arModelId',
